...
def register_user(username, password):
    ...
    role = input("Please enter a role of this user:").lower().strip()
                    ...
                    while True:
                        if wait_time > time.time():
                            ...
                            if count == 0:
                                ...
                                wait_min = 5
                                count = 1
                                input(f"Please wait for another {wait_min:.0f} minutes and {wait_sec:.0f} seconds. Press enter after the timer reaches zero.")
                            else:
                                input(f"Please wait for another {wait_min:.0f} minutes and {wait_sec:.0f} seconds. Press enter after the timer reaches zero.")
